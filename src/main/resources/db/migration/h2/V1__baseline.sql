-- Baseline schema matching the current JPA entities exactly (H2 variant used by tests).
-- The PostgreSQL variant lives in db/migration/postgresql/. They differ only in the
